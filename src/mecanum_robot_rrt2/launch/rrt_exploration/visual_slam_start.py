...
def generate_launch_description():
    ...
    rtabmap = Node(
       ...
       name='rtabmap',
       output='screen',
       parameters=[os.path.join(get_package_share_directory('mecanum_robot_rrt'), 'config', 'rtabmap.yaml'), {"publish_tf": False, 'use_sim_time':use_sim_time}],
    ...
    robot_state_publisher_include = IncludeLaunchDescription(
          PythonLaunchDescriptionSource(
               os.path.join(get_package_share_directory('mecanum_robot_rrt'), 'launch', 'robot_state_publisher.py')
          )
     )
