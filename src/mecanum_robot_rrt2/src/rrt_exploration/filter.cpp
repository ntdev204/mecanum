...
#include "mecanum_rrt_msg/msg/point_array.hpp"
...
class Filter : public rclcpp::Node
{
  public:
    ...
    : Node("filter")
    {
        ...
        filtered_goal_points_publisher = this->create_publisher<mecanum_rrt_msg::msg::PointArray>(filtered_goal_points_publisher_topic,10);
  ...
  private:
    ...
    void timer_callback(){
        ...
        mecanum_rrt_msg::msg::PointArray filtered_goal_points;
    ...
    rclcpp::Publisher<mecanum_rrt_msg::msg::PointArray>::SharedPtr filtered_goal_points_publisher;
