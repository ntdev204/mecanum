...
class Assigner : public rclcpp::Node
{
  public:
    ...
    : Node("assigner")
    {
        ...
        frontiers_subscription_ = this->create_subscription<mecanum_rrt_msg::msg::PointArray>(
  ...
  private:
    ...
    void frontiers_topic_callback(const mecanum_rrt_msg::msg::PointArray::SharedPtr msg)
    {
    ...
    rclcpp::Subscription<mecanum_rrt_msg::msg::PointArray>::SharedPtr frontiers_subscription_;
