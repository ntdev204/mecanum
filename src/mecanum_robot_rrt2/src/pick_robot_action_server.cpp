...
#include "mecanum_rrt_msg/action/pick_coloured_box.hpp"
#include "rclcpp/rclcpp.hpp"
#include "rclcpp_action/rclcpp_action.hpp"
#include "mecanum_rrt_msg/srv/delete_shape.hpp"
...
{
public:
    using PickColouredBox = mecanum_rrt_msg::action::PickColouredBox;
        ...
        : Node("pick_coloured_box_action_server", options)
    {
        ...
        box_deleter_client = this->create_client<mecanum_rrt_msg::srv::DeleteShape>("delete_shape");
    }

private:
    rclcpp_action::Server<PickColouredBox>::SharedPtr action_server_;
    rclcpp::Client<mecanum_rrt_msg::srv::DeleteShape>::SharedPtr box_deleter_client;
    ...
    void execute(const std::shared_ptr<GoalHandlePickColouredBox> goal_handle)
    {
        ...
        if(rclcpp::ok())
        {
            if (goal_handle->is_canceling())
            {
                ...
                auto request = std::make_shared<mecanum_rrt_msg::srv::DeleteShape::Request>();
