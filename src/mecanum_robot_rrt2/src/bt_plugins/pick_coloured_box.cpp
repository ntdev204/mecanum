...
class PickColouredBoxAction : public nav2_behavior_tree::BtActionNode<mecanum_rrt_msg::action::PickColouredBox>
{
public:
  ...
  PickColouredBoxAction(
      ...
      : BtActionNode<mecanum_rrt_msg::action::PickColouredBox>(xml_tag_name, action_name, conf)
  {
  }
