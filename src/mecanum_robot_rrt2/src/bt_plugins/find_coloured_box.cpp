...
#include "mecanum_rrt_msg/action/find_coloured_box.hpp"

class FindColouredBoxAction : public nav2_behavior_tree::BtActionNode<mecanum_rrt_msg::action::FindColouredBox>
{
public:
  ...
  FindColouredBoxAction(
      ...
      : BtActionNode<mecanum_rrt_msg::action::FindColouredBox>(xml_tag_name, action_name, conf)
  {
  }
